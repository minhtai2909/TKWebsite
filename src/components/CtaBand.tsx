...
export function CtaBand({
  ...
  return (
    <section className="relative overflow-hidden bg-steel-900">
      ...
      />
      <div className="absolute -right-24 -top-24 h-72 w-72 rounded-full bg-aqua-500/25 blur-3xl" aria-hidden="true" />
      ...
      <div className="container-tk relative flex flex-col items-start gap-8 py-14 lg:flex-row lg:items-center lg:justify-between lg:py-16">
        ...
        <Reveal delay={120} className="flex shrink-0 flex-col gap-3 sm:flex-row">
          <a
            ...
            className="inline-flex items-center justify-center gap-2 rounded-full bg-accent-500 px-7 py-3.5 text-[15px] font-semibold text-white transition-all hover:bg-accent-600 active:scale-[0.98]"
          >
